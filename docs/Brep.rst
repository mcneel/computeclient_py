...
.. py:function:: IsBox(thisBrep, multiple=False)
   ...
   :rtype: bool
.. py:function:: IsBox1(thisBrep, tolerance, multiple=False)
...
.. py:function:: CreateOffsetBrep(brep, distance, solid, extend, tolerance, multiple=False)
   ...
   :return: Array of Breps if successful. If the function succeeds in offsetting, a \
      ...
      is true).
   :rtype: rhino3dm.Brep[]
.. py:function:: CreateOffsetBrep1(brep, distance, solid, extend, shrink, tolerance, multiple=False)
...
.. py:function:: CreateCurvatureAnalysisMesh(brep, state, multiple=False)
   ...
   :rtype: rhino3dm.Mesh[]
.. py:function:: DestroyRegionTopology(thisBrep, multiple=False)

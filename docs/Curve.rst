...
.. py:function:: CreateFilletCornersCurve(curve, radius, tolerance, angleTolerance, multiple=False)
   ...
   :rtype: rhino3dm.Curve
.. py:function:: JoinCurves(inputCurves, joinTolerance, preserveDirection, multiple=False)
   ...
   :rtype: rhino3dm.Curve[]
.. py:function:: CreateArcLineArcBlend(startPt, startDir, endPt, endDir, radius, multiple=False)
...
.. py:function:: CreateBlendCurve2(curve0, t0, reverse0, continuity0, curve1, t1, reverse1, continuity1, multiple=False)
   ...
   :rtype: rhino3dm.Curve
.. py:function:: CreateMatchCurve(curve0, reverse0, continuity, curve1, reverse1, preserve, average, multiple=False)
...
.. py:function:: MakeClosed(thisCurve, tolerance, multiple=False)
   ...
   :rtype: bool
.. py:function:: CombineShortSegments(thisCurve, tolerance, multiple=False)
